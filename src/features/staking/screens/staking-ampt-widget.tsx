...
import { MaticIcon, AmptIcon } from '../../../app/icons';
...
const icons = [<MaticIcon key={1} />, <AmptIcon key={2} />];

function StakingAMPTWidget() {
    ...
    <PaperStyled>
      <PaperHeader>
        <StakingWidgetRow>
          ...
          <StakingWidgetTitle variant="h5">AMPT on Polygon</StakingWidgetTitle>
        </StakingWidgetRow>
      </PaperHeader>
      {/* <AccordionStyled>
...
export default StakingAMPTWidget;
